...
<body>
	...
	<input value="${alldrawbackpages }" id="alldrawbackpages" type="hidden">
		...
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<div class="container">
					<div class="row">
						<div>
							<a href="<%=basePath %>signed/ourmanagment.do">待我处理</a> | 
							<a href="<%=basePath %>signed/alldrawback.do?pagenum=1" style="text-decoration:underline;">全部申请</a> |
						</div>
					</div>
				</div>
				<div class="container" style="height:20px;"></div>
					<table class="table table-striped table-hover table-responsive table-bordered" id="alldrawbacktable">
						<thead>
							<tr>
								<td colspan="14">
									<input type="text" id="sqname" size="12" placeholder="这里输入客户姓名">
									<button onclick="applynotebyname()" class="btn btn-primary btn-xs" style="margin-left: 2px; line-height: 1.2;font-size: 13px;margin-bottom: 3px; padding: 2px 5px;" >查询</button>
								</td>
							</tr>
							<tr>
							  <th>编号</th>
						  ...
						  <tbody>
						 	<c:forEach items="${alldrawback}" var="signed">
					...
					<div class="container">
						<div class="row" id="pagegroup">
							<div id="alldrawback" class='tcdPageCode col-xs-12 col-sm-6 col-md-8 col-lg-6 col-sm-offset-3 col-md-offset-2 col-lg-offset-3'></div>
						</div>
					</div>
				</div>
		</div>
	...
	<script type="text/javascript">
		$(function () { /* $("[data-toggle='tooltip']").tooltip(); */ $("tr").tooltip(); });
	</script>
